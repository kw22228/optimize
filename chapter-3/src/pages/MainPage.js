...
function MainPage(props) {
    ...
    useEffect(() => {
        ...
        observer.observe(mainImg1.current);
        observer.observe(mainImg2.current);
        observer.observe(mainImg3.current);
    }, []);
    return (
        <div className="MainPage -mt-16">
            ...
            <div className="mx-auto">
                ...
                <TwoColumns
                    bgColor={'#f4f4f4'}
                    columns={[
                        <img data-src={main_items} ref={mainImg1} />,
                        <Meta
                            title={'Items'}
                            content={
                ...
                <TwoColumns
                    ...
                    columns={[
                        <Meta
                            ...
                            btnLink={'/part'}
                        />,
                        <img data-src={main_parts} ref={mainImg2} />,
                    ]}
                    mobileReverse={true}
                />
                <TwoColumns
                    bgColor={'#f4f4f4'}
                    columns={[
                        <img data-src={main_styles} ref={mainImg3} />,
                        <Meta
                            title={'Riding Styles'}
                            content={
